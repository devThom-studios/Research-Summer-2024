...
titles_10 = ['PIOMAS mean from 1982-2014 (m)',
             'C3S mean from 2003-2014 (m)', 
             'CMIP6 10th percent - PIOMAS (m)', 
             'CMIP6 10th percent - C3S (m)']

titles_50 = ['PIOMAS mean from 1982-2014 (m)', 
             'C3S mean from 2003-2014 (m)', 
             'CMIP6 50th percent - PIOMAS (m)', 
             'CMIP6 50th percent - C3S (m)']

titles_90 = ['PIOMAS mean from 1982-2014 (m)', 
             'C3S mean from 2003-2014 (m)', 
             'CMIP6 90th percent - PIOMAS (m)', 
             'CMIP6 90th percent - C3S (m)']

# Plot each percentile
plot_sithick_and_bias([mean_data_piomas_1982_2014.where(mean_data_piomas_1982_2014>=0.02, np.nan), mean_data_c3s_2003_2014, bias_data_10_ssp126_piomas, bias_data_10_ssp126_c3s],titles_10, 'sithick_mean_bias_10th.jpg')
plot_sithick_and_bias([mean_data_piomas_1982_2014.where(mean_data_piomas_1982_2014>=0.02, np.nan), mean_data_c3s_2003_2014, bias_data_50_ssp126_piomas, bias_data_50_ssp126_c3s], titles_50, 'sithick_mean_bias_50th.jpg')
plot_sithick_and_bias([mean_data_piomas_1982_2014.where(mean_data_piomas_1982_2014>=0.02, np.nan), mean_data_c3s_2003_2014, bias_data_90_ssp126_piomas, bias_data_90_ssp126_c3s], titles_90, 'sithick_mean_bias_90th.jpg')
