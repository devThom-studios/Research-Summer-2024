...
def plot_sithick_and_bias(data, titles, file_name):
    ...
    for i, ax in enumerate(axs.flat):
        if i // 2 == 0:
            ...
            contour = ax.pcolormesh(data[i].lon, data[i].lat, data[i][1],
...
titles_10 = [
    'PIOMAS JJA from 1982-2014 (m)',
    'C3S JJA from 2003-2014 (m)',
...
plot_sithick_and_bias([mean_data_piomas_1982_2014.where(mean_data_piomas_1982_2014>=0.02, np.nan), mean_data_c3s_2003_2014, percent_bias_data_10_piomas, percent_bias_data_10_c3s],titles_10, 'sithick_JJA_percent_bias_10th.jpg')

plot_sithick_and_bias([mean_data_piomas_1982_2014.where(mean_data_piomas_1982_2014>=0.02, np.nan), mean_data_c3s_2003_2014, percent_bias_data_50_piomas, percent_bias_data_50_c3s], titles_50, 'sithick_JJA_percent_bias_50th.jpg')

plot_sithick_and_bias([mean_data_piomas_1982_2014.where(mean_data_piomas_1982_2014>=0.02, np.nan), mean_data_c3s_2003_2014, percent_bias_data_90_piomas, percent_bias_data_90_c3s], titles_90, 'sithick_JJA_percent_bias_90th.jpg')
