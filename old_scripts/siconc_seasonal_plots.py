...
#plotting
data_list=[seasonal_data_hadisst_1982_2014, seasonal_data_ostia_1982_2014,seasonal_data_oisst_1982_2014.fillna(0),
...
norm_first_row = colors.Normalize(vmin=0, vmax=100)
norm_second_row = colors.Normalize(vmin=-105, vmax=105)
...
for i, ax in enumerate(axs.flat):
    ...
    if i // 3 == 0:
        ...
        contour1 = ax.contourf(data_list[i].lon, data_list[i].lat, data_list[i][0],
            cmap=cmap,norm=norm,vmin=0,vmax=100, levels=np.round(np.linspace(0, 100, 15),1),
