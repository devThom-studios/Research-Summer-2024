...
bias_data_10_ssp126_hadisst=mean_data_50_ssp126_1982_2014-mean_data_hadisst_1982_2014
bias_data_10_ssp126_ostia=mean_data_50_ssp126_1982_2014-mean_data_ostia_1982_2014
bias_data_10_ssp126_oisst=mean_data_50_ssp126_1982_2014-mean_data_oisst_1982_2014


#plotting
data_list=[mean_data_hadisst_1982_2014,mean_data_ostia_1982_2014,mean_data_oisst_1982_2014.fillna(0),
        bias_data_10_ssp126_hadisst,bias_data_10_ssp126_ostia,bias_data_10_ssp126_oisst.fillna(0)]
...
titles = [
    ...
    'OISST mean from 1982-2014 (%)',
    'CMIP6 90th percent - HadISST (%)',
    'CMIP6 90th percent - OSTIA (%)',
    'CMIP6 90th percent - OISST (%)'
]

fig, axs = plt.subplots(2, 3, subplot_kw={'projection': ccrs.RotatedPole(pole_longitude=83, pole_latitude=42.5)}, figsize=(12, 5))
...
#plt.savefig('siconc_mean_bias_90-p.jpg', dpi=500, bbox_inches='tight')
plt.show()
