...
#plotting
data_list=[mean_data_piomas_1982_2014.fillna(0), mean_data_c3s_2003_2014.fillna(0), bias_data_10_ssp126_piomas.fillna(0), bias_data_10_ssp126_c3s.fillna(0)]
...
plt.savefig('sithick_mean_bias_90-p.jpg', dpi=500, bbox_inches='tight')
plt.show()
